...
<div class="custom-content-account">
	<ul class="my-account-tabs">
		<li><a href="<?php get_site_url();?>/my-account/">MY PROFILE</a></li>
		<li><a href="<?php get_site_url();?>/my-account/orders" class="active">MY ORDERS</a></li>
	</ul>
	<div class="my-tabs mobile-show">
		<div class="current-tab">MY ORDERS</div>
		<div class="dropdown-tabs">
			<div><a href="<?php echo get_site_url();?>/my-account/">MY PROFILE</a></div>
			<div><a href="<?php echo get_site_url();?>/my-account/orders" class="active">MY ORDERS</a></div>
			<!-- <div><a href="<?php echo get_site_url();?>/my-account/my-items">MY ITEMS</a></div> -->
		</div>
	</div>
<?php if ( $has_methods ) : ?>
...
<?php else : ?>
	...
	<p class="woocommerce-Message woocommerce-Message--info woocommerce-info" style="width:100%;float:left;line-height:20px;"><?php esc_html_e( 'No saved methods found.', 'woocommerce' ); ?></p>
