...
<div class="custom-content-account">
	<ul class="my-account-tabs desktop-show">
		...
		<li><a href="<?php echo get_site_url();?>/my-account/orders/" class="active">MY ORDERS</a></li>
	</ul>
...
<?php else : ?>
	<div class="text-center coming-soon-content" style="clear: both;">
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/my-points.png">
		<h3>COMING SOON</h3>
		<hr>
		<p>Come back soon for introductions from our ORDERS.</p>
	</div>
<?php endif; ?>
