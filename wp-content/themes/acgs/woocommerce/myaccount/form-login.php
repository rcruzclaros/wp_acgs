...
<?php endif; ?>
		...
		<div class="right-login-section">
			...
			<ul class="collapsible-acgs custom-login-details">
				<li>
				...
				<li>
					<div class="collapsible-header">
						<i class="fas fa-heart left-icon"></i>
						<h5>Lifetime</h5>
					</div>
				</li>
				<li>
					<div class="collapsible-header">
						<div class="double-icon">
							<i class="fas fa-heart left-icon "></i>
							<i class="fas fa-female left-icon"></i>
						</div>
						<h5>Life Associate</h5>
					</div>
				</li>
				<li>
					<div class="collapsible-header">
				...
				<li>
					<div class="collapsible-header">
						<i class="fas fa-university left-icon"></i>
						<h5>Institutions</h5>
					</div>
				</li>
            </ul>
            <div class="text-center">
            	<a href="<?php echo get_site_url(); ?>/membership" class="base-button color-red"><span>SIGN UP TODAY</span><i class="fas fa-angle-right"></i></a>
            </div>
		</div>
