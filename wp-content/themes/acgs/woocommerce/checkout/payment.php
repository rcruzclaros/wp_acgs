...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<a href="<?php echo get_site_url(); ?>/join/?empty-cart=true" class="cancel-subscribe">Cancel</a>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		setTimeout(function(){
			jQuery('.woocommerce-message').hide(300);
			jQuery('input#place_order').val('Confirm Payment');
		},2000);		
	});
</script>
<?php
